 ...
 * @generated
 */
public class TopicLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TopicLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TopicMapParserProvider.HintAdapter(
					TopicMapElementTypes.Topic_1001, getParserElement(),
					parserHint);
