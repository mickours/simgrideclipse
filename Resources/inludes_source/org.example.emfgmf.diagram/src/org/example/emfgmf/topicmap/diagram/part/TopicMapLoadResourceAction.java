 ...
 * @generated
 */
public class TopicMapLoadResourceAction implements IObjectActionDelegate {

	/**
	 * @generated
	 */
	private TopicMapEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof TopicMapEditPart) {
				mySelectedElement = (TopicMapEditPart) structuredSelection
						.getFirstElement();
			}
		}
