...
import org.example.emfgmf.topicmap.diagram.edit.policies.TopicMapTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AssociationLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TopicMapVisualIDRegistry
						.getType(org.example.emfgmf.topicmap.diagram.edit.parts.AssociationLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AssociationLabelEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return TopicMapElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof TopicMapTextSelectionEditPolicy) {
			((TopicMapTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TopicMapParserProvider.HintAdapter(
					TopicMapElementTypes.Association_3001, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), TopicMapEditPartFactory
