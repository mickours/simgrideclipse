...
import org.example.emfgmf.topicmap.diagram.edit.helpers.TopicMapBaseEditHelper;
import org.example.emfgmf.topicmap.diagram.part.TopicMapVisualIDRegistry;

/**
 * @generated
 */
public class TopicMapBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(TopicMapVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest.setParameter(
					TopicMapBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		if (elementType != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateAssociation_3001(TopicMap container,
				Topic source, Topic target) {
		 ...
		 * @generated
		 */
		public static boolean canExistAssociation_3001(TopicMap container,
				Topic source, Topic target) {
			return true;
		}
