...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>topicmap</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TopicmapExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TopicmapPackage.eNS_URI, 
			 TopicmapPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.topicmap"));
				Topic root = TopicmapFactory.eINSTANCE.createTopic();
